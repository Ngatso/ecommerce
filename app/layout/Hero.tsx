        ...
        <div className="justify-center p-4 max-w-screen-sm bg-white rounded-lg border border-gray-200 shadow lg:mt-0 lg:col-span-5 xl:col-span-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6" action="#">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                href="#"
                className="w-full text-white bg-[#EA4C89] hover:bg-[#d8437c] dark:focus:ring-[#9c0c43] focus:ring-4 focus:outline-none focus:ring-[#f39cbe] font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                Dribbble
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-500 dark:focus:ring-primary-700"
            >
              Create an account
            </button>
